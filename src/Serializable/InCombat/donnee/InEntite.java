...
public class InEntite implements Serializable {
	...
	public InEntite(long id, String nomDonne, String nomClasse, int niveau, Position position, Orientation orientation, CaracteristiquePhysique caracs, ArrayList<InSortPassif> listSP, ArrayList<InSortActif> listSA) {
		this.id = id;
