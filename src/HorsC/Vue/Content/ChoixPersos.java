...
public abstract class ChoixPersos extends Content {
	...
	protected void applyCaracs(HCPersonnage perso) {
		...
		caracValues[5].set(perso.caracMax.tempssup + "");
		caracValues[6].set(perso.caracMax.vitesse + "");
		caracValues[7].set(perso.caracMax.fatigue + "");
	}
	...
	public class ButSortActif extends ButSort {
		...
		public ButSortActif(HCSort sort) {
			super(sort);
		}
