...
public class AttenteCombat extends Content {
	...
	public void partieTrouvee(ArrayList<DonneeJoueur> donnees, int nbrPersos, MapSerializable mapS) {
		addText("Partie trouvée : " + donnees.size() + " joueurs et " + nbrPersos + " persos présents."
				+ "\nMap : " + mapS.nom);
		addText("En attente de nouveaux joueurs ...");
		mapNom.setText(mapS.nom);
	...
	public boolean toAccueil() {
		return Vue.ask("Retour accueil", "Voulez-vous vraiment quitter le salon ?");
	}
