...
import static InC.Vue.HUD.Module.Timeline.RowEntiteTL.EQUIPE_WIDTH;
import static InC.Vue.HUD.Module.Timeline.RowEntiteTL.JAUGE_VIE_WIDTH;
...
public class Vignette extends VBox {
	...
	public Vignette(Image fond, String nom, String equipeCode, int niveau,
			ValeurCarac<IntegerProperty> vitalite) {
		this();
		setData(nom, niveau, fond, nom, vitalite);
	}
	...
	public Vignette() {
		...
		jaugeVie = new Jauge(Orientation.VERTICAL, StyleClass.VITALITE);
	...
	public final void setData(String nom, int niveau, Image fond, String eCode, 
			ValeurCarac<IntegerProperty> vitalite) {
		lNom.setText(nom);
